...
def dataPreprocessing(corpus, toLowerCase = True, stripHTML = True, expandContraction = True, stripAccentedChars = True, removeSplChars = True,
                       removeStopWords = True, numToWords = True, slangWordsRemoval = True, whiteSpaceRemoval = True, lemmatization = True):
    print(len(corpus))
