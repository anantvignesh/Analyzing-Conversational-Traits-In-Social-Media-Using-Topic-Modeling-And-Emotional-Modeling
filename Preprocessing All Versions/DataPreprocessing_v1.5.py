...
def dataPreprocessing(corpus, stripHTML = True, toLowerCase = True, expandContraction = True, stripAccentedChars = True, removeSplChars = True, removeStopWords = True, lemmatization = True):
    print(len(corpus))
