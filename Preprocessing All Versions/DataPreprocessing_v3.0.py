...
def dataPreprocessing(corpus, RTremoval = True, userMentionRemoval = True, toLowerCase = True, stripHTML = True, URLRemoval = True, expandContraction = True, stripAccentedChars = True, removeSplChars = True,
